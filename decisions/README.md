...
| [0034](0034-semantics-1-3-leaf-declaration.md) | RFC-0013 ที่เรายื่นถูก merge · `v1.7.1` ขยับแค่ pointer แล้วกันส่วนที่ต้องมี ADR ไว้ | **C** — เขียน invariant ลง `guarantees` + ประกาศ `transition.reason` ที่ตัวฟิลด์ | 🕒 Proposed |
...
0033 (resource ต้องพกขอบเขตของตัวเอง) ✅
  ↓
0034 (รับ semantics 1.3 — leaf ต้องประกาศ) 🕒
```
