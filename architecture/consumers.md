...
| --- | --- | --- | --- |
| `identity` | `care-agent-platform` ✅ passing · `devfactory-core` ✅ passing · `ecosystem-intelligence` ✅ passing | — | ไม่มี v2 |
...
| `event` 🔗 | `care-agent-platform` ✅ passing · `devfactory-core` ✅ passing · `ecosystem-intelligence` ✅ passing | — | ไม่มี v2 |
